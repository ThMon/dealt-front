      ...
      <Box>
        <Box  pl={4}  pr={4}>
          ...
          <Typography variant="body1">
            Bonjour {session?.user.firstname}, Bienvenue sur votre tableau de bord !<br/> Découvrez ci-dessous les tâches qui vous attendent :
          </Typography>
          <Box mb={1} mt={2} sx={{display: "flex", alignItems: "center", justifyContent:"center"}}>
